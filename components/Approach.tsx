...
const Approach = () => {
  return (
    <section className="w-full py-20" id="interest">
      <h1 className="heading">
        My <span className="text-purple"> Interests </span>
      </h1>
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4 ">
        <Card title="Front-End Development" icon={<AceternityIcon  order='Number One' />}>
          <CanvasRevealEffect
            animationSpeed={5.1}  
            containerClassName="bg-emerald-900"
          />
        </Card>
        <Card title="Back-End Development" icon={<AceternityIcon order='Number Second' />}>
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Database Management" icon={<AceternityIcon order='Number Third' />}>
          <CanvasRevealEffect
            animationSpeed={3}
